  ...
  return (
    <div className="bg-cover bg-center h-screen" style={{ backgroundImage: `url(${LoginIMG})` }}>
      <div className="flex justify-center container mx-auto my-auto w-screen h-screen items-center flex-col">
        ...
        <form onSubmit={Signin} className='w-full md:w-3/4 lg:w-1/2 flex flex-col items-center bg-slate-50 rounded-md pt-12 bg-opacity-5 '>
          ...
          <Link to='/register' className='font-medium text-gray-900 dark:text-blue-500 hover:underline'>Create a Account</Link>
